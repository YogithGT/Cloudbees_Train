...
class TicketServiceImplTest {
    ...
    void bookTicketForUser_validSeatAvailable() throws Exception {
        BookTicketRequest request = new BookTicketRequest("London", "Paris", 20, 12, "Mathew", "mathew@example.com");
        ...
        when(userTicketMapMock.containsKey("mathew@example.com")).thenReturn(false);
        ...
        verify(userTicketMapMock).containsKey("mathew@example.com");
        verify(userTicketMapMock).put("mathew@example.com", bookedTicket);
    ...
    void getTicketDetails_existingUserTicket() throws Exception {
        String emailAddress = "mathew@example.com";
    ...
    void updateUserTicket() throws Exception {
        UpdateTicketRequest updateTicketRequest = new UpdateTicketRequest("mathew@example.com", 2);
        User user = new User();
        user.setEmailAddress("mathew@example.com");
        ...
        when(userTicketMapMock.containsKey("mathew@example.com")).thenReturn(true);
        when(userTicketMapMock.get("mathew@example.com")).thenReturn(ticket);
        ...
        verify(userTicketMapMock).get("mathew@example.com");
