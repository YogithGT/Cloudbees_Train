...
public class TicketServiceImpl implements TicketService {
    ...
    TicketServiceImpl() {
        ...
        for (int seat = 1; seat <= 40; seat++) {
            Section section = seat <= 20 ? Section.A : Section.B;
    ...
    public BookTicketResponse bookTicketForUser(BookTicketRequest bookTicketRequest) throws Exception {
        ...
        if (userTicketMap.containsKey(bookTicketRequest.getEmailAddress())) {
            throw new Exception("User has already booked ticket, seat number: "
                    + userTicketMap.get(bookTicketRequest.getEmailAddress()).getSeatNumber());
        }
    ...
    public void deleteUserTicket(String emailAddress) throws Exception {
        ...
        seatStatus.put(ticket.getSeatNumber(),
                Pair.of(seatStatus.get(ticket.getSeatNumber()).getLeft(), Boolean.FALSE));
